...
```
wget -qO- https://github.com/CaspianGeben/OctoDash/raw/master/scripts/install.sh | bash -s -- --ptg
```
...
```
wget -qO- https://github.com/CaspianGeben/OctoDash/raw/master/scripts/update.sh | bash
```
